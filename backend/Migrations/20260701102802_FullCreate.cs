...
namespace backend.Migrations
{
    ...
    public partial class FullCreate : Migration
    {
        ...
        {
            // Only adding JobPosts and JobApplications since others already exist in the database
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPosts_Users_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobApplications_ServiceProviders_ProviderId",
