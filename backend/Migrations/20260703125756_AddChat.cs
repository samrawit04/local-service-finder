...
namespace backend.Migrations
{
    ...
    public partial class AddChat : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChatConversations_JobApplications_JobApplicationId",
                        column: x => x.JobApplicationId,
                        principalTable: "JobApplications",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChatConversations_Users_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatConversations_Users_ProviderUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatConversations_JobApplicationId",
                table: "ChatConversations",
                column: "JobApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatConversations_ProviderUserId",
                table: "ChatConversations",
